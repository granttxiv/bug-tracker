...
const featureCards = [
  {
    title: "Dashboard",
    description: "Track sprint health, resolutions, and team velocity from one view.",
    href: "/dashboard",
  },
  {
    title: "Board",
    description: "Move work across statuses and understand where priorities are stalled.",
    href: "/board",
  },
  {
    title: "Issues",
    description: "Filter, triage, and review the bug backlog without losing context.",
    href: "/issues",
  },
  {
    title: "Backlog",
          ...
          <div className="grid gap-8 p-6 md:p-10 lg:grid-cols-[1.2fr_0.8fr] lg:p-12">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-slate-600">
                Keep delivery moving with a single place for release health, team updates, and the
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl bg-emerald-50 p-5 shadow-sm">
                ...
                <h2 className="mt-3 text-3xl font-bold text-emerald-600">Connected</h2>
              </div>
            </div>
          </div>
        </section>
